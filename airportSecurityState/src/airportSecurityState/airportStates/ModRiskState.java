...
public class ModRiskState implements AirportStateI{
    private static final MyLogger myLogger = new MyLogger();

    /**
     * Creates a new ModRiskState
     * @param none
     * @return none
     */
    public ModRiskState(){
        myLogger.writeOutput("New ModRiskState has been constructed", MyLogger.DEBUG_VALUE.CONSTRUCTOR);
    }
    /**
